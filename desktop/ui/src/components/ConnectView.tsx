    ...
    <div className="view active" id="viewConnect">
      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="field"><label htmlFor="c-url">URL</label><input type="text" id="c-url" placeholder="http://localhost:4321" value={url} onChange={e => setUrl(e.target.value)} /></div>
          <div className="field"><label htmlFor="c-username" id="t-username-label">{T.username}</label><input type="text" id="c-username" placeholder="admin@example.com" value={username} onChange={e => setUsername(e.target.value)} /></div>
          <div className="field"><label htmlFor="c-password" id="t-password-label">Password</label><input type="password" id="c-password" value={password} onChange={e => setPassword(e.target.value)} /></div>
